...
def random_signals_generator(nb_signals, nb_dates, vol_signals, correl_signals, rand_vector_signals = None) :
        
    #Définition de la matrice de var-covar
...
def random_assets_generator(signals_matrix, nb_assets, nb_dates, vol_assets, correl_assets, signal_to_noise, rank_betas,
                            rand_vector_betas = None, rand_vector_noise = None) : 
    ...
    assets = signals_matrix @ betas + noise
